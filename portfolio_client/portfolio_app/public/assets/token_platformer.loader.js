function createUnityInstance(canvas, config, onProgress) {
  ...
  fallbackToDefaultConfigWithWarning(config, "companyName", "Prelude Productions");
  fallbackToDefaultConfigWithWarning(config, "productName", "Token Platformer");
  fallbackToDefaultConfigWithWarning(config, "productVersion", "2.0");
